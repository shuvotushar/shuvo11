...
os.system('clear')
psb('\x1b[1;32mBANGLADESHTUSHAR' 11 DIGIT CLONING START PLEASE WAIT ..........')
for n in range(9999):
...
def menu():
    ...
    print logo
    print ''
    print 'AUTHOR   : SHUVO TUSHAR'
    print 'FACEBOOK : ABDUL KADER SHUVO'
    print 'GITHUB     : github.com/shuvotushar'
    print ''
    print 50* '-'
    print '[1]  \x1b[1;96mGP'
